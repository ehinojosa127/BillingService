...
# Defaults de emisor si el .env no los define (Docker env_file puede dejarlos vacíos).
ENV ISSUER_LEGAL_NAME=EMPRESA DEMO S.A.C.
ENV ISSUER_TRADE_NAME=EMPRESA DEMO
ENV ISSUER_ADDRESS_LINE=AV. DEMO 123
ENV ISSUER_UBIGEO=150101
ENV ISSUER_DEPARTMENT=LIMA
ENV ISSUER_PROVINCE=LIMA
ENV ISSUER_DISTRICT=LIMA
EXPOSE 8080
